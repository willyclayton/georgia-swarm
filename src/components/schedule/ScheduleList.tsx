        ...
        return (
          ...
          >
            ...
            <div className="w-8 text-center">
              <span className={`text-xs font-medium ${game.is_home ? 'text-swarm-gold' : 'text-swarm-muted'}`}>
                {game.is_home ? 'vs' : '@'}
              </span>
            </div>
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              {isFinal && swarmScore !== undefined && (
                <>
                  ...
                  <span className="text-swarm-text font-bold tabular-nums text-sm">
                    {swarmScore}–{oppScore}
                  </span>
                </>
              )}
              ...
              <ChevronRight size={16} className="text-swarm-muted" />
            </div>
          </Link>
        );
      })}
